...
public class MySQLConnection {
    ...
    public void setFavoriteItem(String userId, Item item) throws MySQLException {
        ...
        if (conn == null) {
            ...
            throw new MySQLException("Fail to connect to the database.");
        }
        // In case item has not been added to the ITEM table
        saveItem(item);
    ...
    public Map<String, List<Item>> getFavoriteItems(String userId) throws MySQLException {
        if (conn == null) {
            System.err.println("Fail to connect to greylight");
            throw new MySQLException("Fail to connect to greylight");
        }
    ...
    public boolean addUser(User user) throws MySQLException {
        ...
        try {
            ...
            // Check if the insert operation succeeded in adding one row
