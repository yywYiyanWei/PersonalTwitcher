...
public class TwitchClient {
    // Access token
    private static final String TOKEN = "Bearer cgl4z2pw5y0zigifa6q3yoh0oaoy0e";
    private static final String CLIENT_ID = "sst48ducl8wds0qr1eyqzi8w2fuiov";
    ...
    public List<Item> getItemList(String data) throws TwitchException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new TwitchException("Fail to parse item data from Twitch API");
        }
    }
